...
class AppApi {
  ...
  Future<Map<String, dynamic>> _request(
    ...
    final payload = raw.isEmpty ? <String, dynamic>{} : jsonDecode(raw) as Map<String, dynamic>;
  ...
  Future<List<Map<String, dynamic>>> favorites() async {
    ...
    return (data['favorites'] as List? ?? const []).cast<Map<String, dynamic>>();
  }
  ...
  Future<void> updateProfile({required String displayName, required String preferredLanguage}) async {
